...
!--- 1. Note: this program assumes a cubic reciprocal unit cell (RUC) and quadratic dispersion, cylindrical Fermi surface
...
!--- 12. Calculate the energy of each point, in Ryd, and write to file
   ...
   e(linepos)=eoffset + (piconvfsdade2mstar*((kxdummy*kxdummy)+(kydummy*kydummy))/mstar)
